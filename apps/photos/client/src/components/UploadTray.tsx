...
export function UploadTray({ batch }: { batch: UploadBatch | null }) {
  ...
  return (
    <div className="fixed left-1/2 -translate-x-1/2 bottom-[104px] z-50 w-[min(320px,86vw)] bg-film-2 border border-paper/12 rounded-2xl px-4 py-3 shadow-[0_10px_30px_rgba(0,0,0,0.5)]">
