...
import { useWebSockets, type WsListener } from './useWebSockets'
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  // WebSocket connection for real-time updates (always on — the roll is public)
  const handleReset = useCallback(() => setUser(null), [])
  const { resetMessage, setResetMessage, subscribe } = useWebSockets({
