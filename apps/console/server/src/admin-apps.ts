 ...
 * source of truth in `@console-starter/console-shared`, shared with alchemy.run.ts. This module re-exports
...
export { MANAGED_APPS, type ManagedApp, type ChildBindingKey } from '@console-starter/console-shared'
