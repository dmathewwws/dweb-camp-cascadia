 ...
 * source of truth in `@dweb/console-shared`, shared with alchemy.run.ts. This module re-exports
...
export { MANAGED_APPS, type ManagedApp, type ChildBindingKey } from '@dweb/console-shared'
